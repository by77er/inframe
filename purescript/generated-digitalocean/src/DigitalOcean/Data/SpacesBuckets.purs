module DigitalOcean.Data.SpacesBuckets
  ( Args
  , Required
  , SpacesBuckets
  , SpacesBucketsDataSource
  , args
  , read
  , Filter
  , FilterRequired
...
type SpacesBuckets =
  { dataSource :: DataSource SpacesBucketsDataSource
  , buckets :: Expr (Array ({ bucketDomainName :: String, endpoint :: String, name :: String, region :: String, urn :: String }))
  , id :: Expr String
  }

read :: String -> Args -> Infra SpacesBuckets
read logicalName (Args values) = do
  handle <- addDataSource "digitalocean_spaces_buckets" logicalName values
  pure
    { dataSource: handle
    , buckets: dataSourceAttr handle [ "buckets" ]
