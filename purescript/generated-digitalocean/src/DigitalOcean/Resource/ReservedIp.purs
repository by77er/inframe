module DigitalOcean.Resource.ReservedIp
  ( Args
  , Required
  , ReservedIp
  , ReservedIpResource
...
type ReservedIp =
  { resource :: Resource ReservedIpResource
...
create :: String -> Args -> Infra ReservedIp
create logicalName (Args values) = do
  handle <- addResource "digitalocean_reserved_ip" logicalName values
  pure
    { resource: handle
