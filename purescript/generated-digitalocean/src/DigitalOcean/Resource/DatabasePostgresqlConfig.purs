...
autovacuumAnalyzeScaleFactor value (Args values) = Args (Object.insert "autovacuum_analyze_scale_factor" (inputJson value) values)

autovacuumAnalyzeThreshold :: Input Number -> Args -> Args
autovacuumAnalyzeThreshold value (Args values) = Args (Object.insert "autovacuum_analyze_threshold" (inputJson value) values)

autovacuumFreezeMaxAge :: Input Number -> Args -> Args
autovacuumFreezeMaxAge value (Args values) = Args (Object.insert "autovacuum_freeze_max_age" (inputJson value) values)

autovacuumMaxWorkers :: Input Number -> Args -> Args
autovacuumMaxWorkers value (Args values) = Args (Object.insert "autovacuum_max_workers" (inputJson value) values)

autovacuumNaptime :: Input Number -> Args -> Args
autovacuumNaptime value (Args values) = Args (Object.insert "autovacuum_naptime" (inputJson value) values)

autovacuumVacuumCostDelay :: Input Number -> Args -> Args
autovacuumVacuumCostDelay value (Args values) = Args (Object.insert "autovacuum_vacuum_cost_delay" (inputJson value) values)

autovacuumVacuumCostLimit :: Input Number -> Args -> Args
autovacuumVacuumCostLimit value (Args values) = Args (Object.insert "autovacuum_vacuum_cost_limit" (inputJson value) values)

autovacuumVacuumScaleFactor :: Input Number -> Args -> Args
autovacuumVacuumScaleFactor value (Args values) = Args (Object.insert "autovacuum_vacuum_scale_factor" (inputJson value) values)

autovacuumVacuumThreshold :: Input Number -> Args -> Args
autovacuumVacuumThreshold value (Args values) = Args (Object.insert "autovacuum_vacuum_threshold" (inputJson value) values)

backupHour :: Input Number -> Args -> Args
backupHour value (Args values) = Args (Object.insert "backup_hour" (inputJson value) values)

backupMinute :: Input Number -> Args -> Args
backupMinute value (Args values) = Args (Object.insert "backup_minute" (inputJson value) values)

bgwriterDelay :: Input Number -> Args -> Args
bgwriterDelay value (Args values) = Args (Object.insert "bgwriter_delay" (inputJson value) values)

bgwriterFlushAfter :: Input Number -> Args -> Args
bgwriterFlushAfter value (Args values) = Args (Object.insert "bgwriter_flush_after" (inputJson value) values)

bgwriterLruMaxpages :: Input Number -> Args -> Args
bgwriterLruMaxpages value (Args values) = Args (Object.insert "bgwriter_lru_maxpages" (inputJson value) values)

bgwriterLruMultiplier :: Input Number -> Args -> Args
bgwriterLruMultiplier value (Args values) = Args (Object.insert "bgwriter_lru_multiplier" (inputJson value) values)

deadlockTimeout :: Input Number -> Args -> Args
deadlockTimeout value (Args values) = Args (Object.insert "deadlock_timeout" (inputJson value) values)

defaultToastCompression :: Input String -> Args -> Args
defaultToastCompression value (Args values) = Args (Object.insert "default_toast_compression" (inputJson value) values)

id :: Input String -> Args -> Args
id value (Args values) = Args (Object.insert "id" (inputJson value) values)

idleInTransactionSessionTimeout :: Input Number -> Args -> Args
idleInTransactionSessionTimeout value (Args values) = Args (Object.insert "idle_in_transaction_session_timeout" (inputJson value) values)

jit :: Input Boolean -> Args -> Args
jit value (Args values) = Args (Object.insert "jit" (inputJson value) values)

logAutovacuumMinDuration :: Input Number -> Args -> Args
logAutovacuumMinDuration value (Args values) = Args (Object.insert "log_autovacuum_min_duration" (inputJson value) values)

logErrorVerbosity :: Input String -> Args -> Args
logErrorVerbosity value (Args values) = Args (Object.insert "log_error_verbosity" (inputJson value) values)

logLinePrefix :: Input String -> Args -> Args
logLinePrefix value (Args values) = Args (Object.insert "log_line_prefix" (inputJson value) values)

logMinDurationStatement :: Input Number -> Args -> Args
logMinDurationStatement value (Args values) = Args (Object.insert "log_min_duration_statement" (inputJson value) values)

maxFilesPerProcess :: Input Number -> Args -> Args
maxFilesPerProcess value (Args values) = Args (Object.insert "max_files_per_process" (inputJson value) values)

maxLocksPerTransaction :: Input Number -> Args -> Args
maxLocksPerTransaction value (Args values) = Args (Object.insert "max_locks_per_transaction" (inputJson value) values)

maxLogicalReplicationWorkers :: Input Number -> Args -> Args
maxLogicalReplicationWorkers value (Args values) = Args (Object.insert "max_logical_replication_workers" (inputJson value) values)

maxParallelWorkers :: Input Number -> Args -> Args
maxParallelWorkers value (Args values) = Args (Object.insert "max_parallel_workers" (inputJson value) values)

maxParallelWorkersPerGather :: Input Number -> Args -> Args
maxParallelWorkersPerGather value (Args values) = Args (Object.insert "max_parallel_workers_per_gather" (inputJson value) values)

maxPredLocksPerTransaction :: Input Number -> Args -> Args
maxPredLocksPerTransaction value (Args values) = Args (Object.insert "max_pred_locks_per_transaction" (inputJson value) values)

maxPreparedTransactions :: Input Number -> Args -> Args
maxPreparedTransactions value (Args values) = Args (Object.insert "max_prepared_transactions" (inputJson value) values)

maxReplicationSlots :: Input Number -> Args -> Args
maxReplicationSlots value (Args values) = Args (Object.insert "max_replication_slots" (inputJson value) values)

maxStackDepth :: Input Number -> Args -> Args
maxStackDepth value (Args values) = Args (Object.insert "max_stack_depth" (inputJson value) values)

maxStandbyArchiveDelay :: Input Number -> Args -> Args
maxStandbyArchiveDelay value (Args values) = Args (Object.insert "max_standby_archive_delay" (inputJson value) values)

maxStandbyStreamingDelay :: Input Number -> Args -> Args
maxStandbyStreamingDelay value (Args values) = Args (Object.insert "max_standby_streaming_delay" (inputJson value) values)

maxWalSenders :: Input Number -> Args -> Args
maxWalSenders value (Args values) = Args (Object.insert "max_wal_senders" (inputJson value) values)

maxWorkerProcesses :: Input Number -> Args -> Args
maxWorkerProcesses value (Args values) = Args (Object.insert "max_worker_processes" (inputJson value) values)

pgPartmanBgwInterval :: Input Number -> Args -> Args
pgPartmanBgwInterval value (Args values) = Args (Object.insert "pg_partman_bgw_interval" (inputJson value) values)

pgPartmanBgwRole :: Input String -> Args -> Args
pgPartmanBgwRole value (Args values) = Args (Object.insert "pg_partman_bgw_role" (inputJson value) values)

pgStatStatementsTrack :: Input String -> Args -> Args
pgStatStatementsTrack value (Args values) = Args (Object.insert "pg_stat_statements_track" (inputJson value) values)

pgbouncer :: Input (Array ({ autodbIdleTimeout :: Number, autodbMaxDbConnections :: Number, autodbPoolMode :: String, autodbPoolSize :: Number, ignoreStartupParameters :: Array String, minPoolSize :: Number, serverIdleTimeout :: Number, serverLifetime :: Number, serverResetQueryAlways :: Boolean })) -> Args -> Args
pgbouncer value (Args values) = Args (Object.insert "pgbouncer" (inputJson value) values)

sharedBuffersPercentage :: Input Number -> Args -> Args
sharedBuffersPercentage value (Args values) = Args (Object.insert "shared_buffers_percentage" (inputJson value) values)

tempFileLimit :: Input Number -> Args -> Args
tempFileLimit value (Args values) = Args (Object.insert "temp_file_limit" (inputJson value) values)

timescaledb :: Input (Array ({ maxBackgroundWorkers :: Number })) -> Args -> Args
timescaledb value (Args values) = Args (Object.insert "timescaledb" (inputJson value) values)

timezone :: Input String -> Args -> Args
timezone value (Args values) = Args (Object.insert "timezone" (inputJson value) values)

trackActivityQuerySize :: Input Number -> Args -> Args
trackActivityQuerySize value (Args values) = Args (Object.insert "track_activity_query_size" (inputJson value) values)

trackCommitTimestamp :: Input String -> Args -> Args
trackCommitTimestamp value (Args values) = Args (Object.insert "track_commit_timestamp" (inputJson value) values)

trackFunctions :: Input String -> Args -> Args
trackFunctions value (Args values) = Args (Object.insert "track_functions" (inputJson value) values)

trackIoTiming :: Input String -> Args -> Args
trackIoTiming value (Args values) = Args (Object.insert "track_io_timing" (inputJson value) values)

walSenderTimeout :: Input Number -> Args -> Args
walSenderTimeout value (Args values) = Args (Object.insert "wal_sender_timeout" (inputJson value) values)

walWriterDelay :: Input Number -> Args -> Args
walWriterDelay value (Args values) = Args (Object.insert "wal_writer_delay" (inputJson value) values)

workMem :: Input Number -> Args -> Args
workMem value (Args values) = Args (Object.insert "work_mem" (inputJson value) values)
