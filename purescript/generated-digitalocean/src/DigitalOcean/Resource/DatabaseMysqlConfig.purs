...
binlogRetentionPeriod value (Args values) = Args (Object.insert "binlog_retention_period" (inputJson value) values)

connectTimeout :: Input Number -> Args -> Args
connectTimeout value (Args values) = Args (Object.insert "connect_timeout" (inputJson value) values)

defaultTimeZone :: Input String -> Args -> Args
defaultTimeZone value (Args values) = Args (Object.insert "default_time_zone" (inputJson value) values)

groupConcatMaxLen :: Input Number -> Args -> Args
groupConcatMaxLen value (Args values) = Args (Object.insert "group_concat_max_len" (inputJson value) values)

id :: Input String -> Args -> Args
id value (Args values) = Args (Object.insert "id" (inputJson value) values)

informationSchemaStatsExpiry :: Input Number -> Args -> Args
informationSchemaStatsExpiry value (Args values) = Args (Object.insert "information_schema_stats_expiry" (inputJson value) values)

innodbFtMinTokenSize :: Input Number -> Args -> Args
innodbFtMinTokenSize value (Args values) = Args (Object.insert "innodb_ft_min_token_size" (inputJson value) values)

innodbFtServerStopwordTable :: Input String -> Args -> Args
innodbFtServerStopwordTable value (Args values) = Args (Object.insert "innodb_ft_server_stopword_table" (inputJson value) values)

innodbLockWaitTimeout :: Input Number -> Args -> Args
innodbLockWaitTimeout value (Args values) = Args (Object.insert "innodb_lock_wait_timeout" (inputJson value) values)

innodbLogBufferSize :: Input Number -> Args -> Args
innodbLogBufferSize value (Args values) = Args (Object.insert "innodb_log_buffer_size" (inputJson value) values)

innodbOnlineAlterLogMaxSize :: Input Number -> Args -> Args
innodbOnlineAlterLogMaxSize value (Args values) = Args (Object.insert "innodb_online_alter_log_max_size" (inputJson value) values)

innodbPrintAllDeadlocks :: Input Boolean -> Args -> Args
innodbPrintAllDeadlocks value (Args values) = Args (Object.insert "innodb_print_all_deadlocks" (inputJson value) values)

innodbRollbackOnTimeout :: Input Boolean -> Args -> Args
innodbRollbackOnTimeout value (Args values) = Args (Object.insert "innodb_rollback_on_timeout" (inputJson value) values)

interactiveTimeout :: Input Number -> Args -> Args
interactiveTimeout value (Args values) = Args (Object.insert "interactive_timeout" (inputJson value) values)

internalTmpMemStorageEngine :: Input String -> Args -> Args
internalTmpMemStorageEngine value (Args values) = Args (Object.insert "internal_tmp_mem_storage_engine" (inputJson value) values)

longQueryTime :: Input Number -> Args -> Args
longQueryTime value (Args values) = Args (Object.insert "long_query_time" (inputJson value) values)

maxAllowedPacket :: Input Number -> Args -> Args
maxAllowedPacket value (Args values) = Args (Object.insert "max_allowed_packet" (inputJson value) values)

maxHeapTableSize :: Input Number -> Args -> Args
maxHeapTableSize value (Args values) = Args (Object.insert "max_heap_table_size" (inputJson value) values)

netReadTimeout :: Input Number -> Args -> Args
netReadTimeout value (Args values) = Args (Object.insert "net_read_timeout" (inputJson value) values)

netWriteTimeout :: Input Number -> Args -> Args
netWriteTimeout value (Args values) = Args (Object.insert "net_write_timeout" (inputJson value) values)

slowQueryLog :: Input Boolean -> Args -> Args
slowQueryLog value (Args values) = Args (Object.insert "slow_query_log" (inputJson value) values)

sortBufferSize :: Input Number -> Args -> Args
sortBufferSize value (Args values) = Args (Object.insert "sort_buffer_size" (inputJson value) values)
...
sqlRequirePrimaryKey value (Args values) = Args (Object.insert "sql_require_primary_key" (inputJson value) values)

tmpTableSize :: Input Number -> Args -> Args
tmpTableSize value (Args values) = Args (Object.insert "tmp_table_size" (inputJson value) values)

waitTimeout :: Input Number -> Args -> Args
waitTimeout value (Args values) = Args (Object.insert "wait_timeout" (inputJson value) values)
